...
def benchmark_origin():
    ...
    os.system("python -m accediff.inference.generate_video_text_to_video prompt_sources=videos output_root_dir=outputs_video_video_prompts")

UNION_ARGS="""\
        prompt_sources=videos \
        output_root_dir=outputs_video_video_prompts \
        get_pipeline.tome_modele_names=["transformer_blocks.\{0..27\}.attn1"] \
"""
