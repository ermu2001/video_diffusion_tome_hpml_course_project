...
def _get_cogvideox_tome_token_merging_hooks(pipe):
    ...
    merge_ratio = 0.5  # Adjust the merge ratio as needed
...
def get_cogvideox_pipeline_with_tome(repo_id="THUDM/CogVideoX-5b", tome_modele_names: List[str]=None):
    ...
    pre_forward_hook, post_forward_hook = _get_cogvideox_tome_token_merging_hooks(pipe)
